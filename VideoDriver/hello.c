// Userspace program that testing the water-raid project
// Copyright (C) 2022  Tristan Saidi
// Based on the Userspace program that communicates with the vga_ball device driver 
// Copyright (C) 2021 Stephen A. Edwards
